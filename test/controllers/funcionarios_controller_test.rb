...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, dependentes: @funcionario.dependentes, documento: @funcionario.documento, endereco: @funcionario.endereco, nome: @funcionario.nome, responsabilidades: @funcionario.responsabilidades, salario: @funcionario.salario, telefone: @funcionario.telefone } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, dependentes: @funcionario.dependentes, documento: @funcionario.documento, endereco: @funcionario.endereco, nome: @funcionario.nome, responsabilidades: @funcionario.responsabilidades, salario: @funcionario.salario, telefone: @funcionario.telefone } }
