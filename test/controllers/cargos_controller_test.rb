...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { funcionarios_id: @cargo.funcionarios_id, nome: @cargo.nome, observacoes: @cargo.observacoes } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { funcionarios_id: @cargo.funcionarios_id, nome: @cargo.nome, observacoes: @cargo.observacoes } }
